...
echo "<td style=\"background-color:gray\" width=7%>[0,0x7ff]<br>保留供v86使用<br>size=2k</td><td style=\"background-color:#00aaaa\" width=7%>[0x800,0xfff]<br>VBE信息块<br>size=2k</td><td style=\"background-color:#e08080\" width=12%>[0x1000,0x7fff]<br>V86使用<br>size=28k</td><td style=\"background-color:gray\" width=10%>[0x8000,0xbfff]<br>全局描述符表GDT<br>size:2048*8=16k</td><td style=\"background-color:yellow\" width=38%>[0xc000,0x9ffff]<br>DMA缓冲<br>size=592k</td><td style=\"background-color:gray\" width=26%>[0xA0000,0xfffff]<br>保留供V86使用<br>size=384k</td></tr></table>";
