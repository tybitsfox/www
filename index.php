...
echo "</td><td colspan=2 align=left valign=top><form name='form1' method='get' action='https://magi.com/search' target=_blank><table class='aaaa'><tr><td align=left width=100px>站外搜索：</td><td align=left width=160px><input type=text name=q size=20 /></td><td align=left><input type=submit value='搜 索' />&nbsp;&nbsp;<input type=reset value='清空' /></td></tr><tr><td colspan=3>";
