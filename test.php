...
if($pflag==0)
{
	...
	echo "<tr><td align=center width=25%><a href='./tin16/hhh/ff9_index.php' target=_blank>最终幻想9</td>";
	...
	echo "<td align=center width=25% ><a href='./tin16/nnn/dq8.html' target=_blank>勇者斗恶龙8</a></td>";
	echo "</tr>";
