...
<table border='1' cellspacing='1' cellpadding='1' align='center'>
    <tbody align='center'>
        ...
        <tr>
            <td bgcolor='#99ccff' rowspan='2'>能力修正</td>
            <td width='100'>力量</td>
            <td width='100'>守备</td>
            <td width='100'>速度</td>
            <td width='100'>智慧</td>
            <td width='100'>魅力</td>
            <td width='100'>MAXHP</td>
            <td width='100'>MAXMP</td>
        </tr>
        <tr>
            <td>+10%</td>
            <td>-</td>
        ...
        <tr>
            <td bgcolor='#99ccff' colspan='2'>职业等级</td>
            <td bgcolor='#99ccff' colspan='2'>战斗经验</td>
            <td bgcolor='#99ccff' colspan='2'>称号</td>
            <td bgcolor='#99ccff' colspan='2'>修得特技</td>
        </tr>
        <tr>
