...
for($i=0;$i<$j;$i++)
{
	...
	echo $st;
		...
		$st2="<a href='".$SIGNED_DEF['LINK']."' >主页</a></li><li><a href='".$SIGNED_DEF['LINK']."?select=".$SIGNED_PAGE['ONE']."'>设置</a></li><li>我的测试";
		$st1=sprintf($SIG_HTML['RIGHT_TOP1'],$st2);
		echo $st1;
		echo "<div class='inner' id='modal_container' >\n<h2 class='sect first'>设置 / 我的测试</h2>\n";
		$st1="<div class='block'>
        ...
        <p>我邀请的合作伙伴.</p>
                ...
                <div class='nav-vendors'>
                    ...
                    <div class='tab-content tab-content-vertical'>
                            <div role='tabpanel' class='tab-pane' id='vendor-expert'>
                                    <div class='shareblock'>
                                        ...
                                        <div class='shareblock-body'>
                                            <ul class='list-unstyled list-shares'><br>
											<button type='submit' class='btn btn-danger'>解除选中的合作伙伴 <i class='icon-ok'></i></button>
                                            </ul>
                                        </div>
                                    </div>
                            </div>
					<!-- my add -->
                            <div role='tabpanel' class='tab-pane active' id='vendor-company'>
                                    <div class='shareblock'>
                                        <div class='shareblock-head shareblock-head-light'>
                    ...
                    <!-- Vendor Panes -->
                            <div role='tabpanel' class='tab-pane' id='vendor-addexpert'>
                                    <div class='shareblock'>
                                        <div class='shareblock-head shareblock-head-light'>
                                            <p class='shareblock-account'><span class='light'>合作伙伴:</span> <strong><span class='account-truncated'>周洁</span></strong></p>
                                            <a href='/app/accounts/6adgokW5xo/edit?tab=collaborators' class='btn btn-primary withicon btn-shareaccount' data-toggle-inactive='modal' data-target='#modal-shareaccount'><i class='icon-pencil'></i> 开始交流</a>
