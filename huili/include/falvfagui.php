...
$pg_sel=array(array("active",""),
		array("active","coll","tab1","icon-user","地方法规","您还没有合作的专家或团队"),
		array("","invit","tab2","icon-group","执行标准","普通账户无法发送博客"),
		);
...
<div class='shareblock-head shareblock-head-light'><label style='text-align:center;'><input type='radio' name='optionsRadios' id='rad01' value='1' checked>水环境标准</label></div>
<div class='shareblock-head shareblock-head-light'><label style='text-align:center;'><input type='radio' name='optionsRadios' id='rad02' value='2'>气环境标准</label></div>
<div class='shareblock-head shareblock-head-light'><label style='text-align:center;'><input type='radio' name='optionsRadios' id='rad03' value='3'>环境监测</label></div>
</div>";
echo $ft5;
echo "<br><div class='text-center'><a class='btn btn-outline' href='#'>浏览查询</a></div>";
//}}}
