...
CREATE TABLE `blog` (
  ...
  `header` varchar(256) DEFAULT NULL COMMENT '简介',
  `enshow` int(4) unsigned NOT NULL COMMENT '是否显示',
...
-- Dump completed on 2018-07-29 19:28:57
