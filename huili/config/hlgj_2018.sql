...
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `blog` (
  `tuid` int(12) unsigned NOT NULL COMMENT '帖子id',
  ...
  PRIMARY KEY (`tuid`),
  KEY `time_id` (`fintime`,`uid`),
  KEY `idx_show` (`idx`,`isshow`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2018-08-01 12:46:05
