...
CREATE TABLE `comp_info` (
  `idx` int(11) NOT NULL AUTO_INCREMENT COMMENT '序号',
  `name` varchar(256) NOT NULL COMMENT '企业名称',
  `tid` int(4) unsigned NOT NULL COMMENT '行业类别',
  `jianjie` text NOT NULL COMMENT '简介',
  `sheng` varchar(32) NOT NULL COMMENT '所属省份',
  `dishi` varchar(32) NOT NULL COMMENT '所属地市',
  PRIMARY KEY (`idx`),
  KEY `name_tid` (`name`(191),`tid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2018-08-26 20:48:08
