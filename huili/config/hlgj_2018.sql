...
CREATE TABLE `talkmsg` (
  `uid` int(32) unsigned NOT NULL COMMENT '邀请者id',
  `eid` int(32) unsigned NOT NULL COMMENT '专家id',
  `tdate` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00' COMMENT '发布时间',
  `msg` text NOT NULL COMMENT '聊天信息',
  `uused` int(1) unsigned NOT NULL COMMENT '邀请者已读取',
  `ueid` int(1) unsigned NOT NULL COMMENT '专家已读取',
  PRIMARY KEY (`uid`,`eid`),
  KEY `bydate` (`tdate`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2018-07-18 16:19:52
