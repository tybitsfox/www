...
//右边默认界面及默认界面的展开代码
$SIG_HTML['RIGHT_TOP2']	=	"<div class='tab-content'><div role='tabpanel' class='tab-pane tab-pane-naked active' id='latestorders'><section><div class='orders-empty panel'><img class='picto' src='".$SIGNED_DEF['PICTO_PNG']."' alt='空'><p>%s</p><a href='".$SIGNED_DEF['LINK']."?select=".$SIGNED_PAGE['ADD']."' class='btn btn-primary withlasticon'>添加<i class='icon-plus'></i></a></div></section></div></div>";
