...
<?php
echo "<br><br><a href='http://www.pubyun.com/' target=_blank>希网动态</a><br>";
echo "<a href='https://www.ctfile.com/' target=_blank>城通网盘</a><br>";
...
echo "<a href='http://vdisk.weibo.com' target=_blank>我的微盘</a><br>";
echo "<a href='https://coding.net/' target=_blank>coding</a><br>";
